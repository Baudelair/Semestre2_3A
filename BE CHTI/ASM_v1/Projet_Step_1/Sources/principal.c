...
int main(void)
{
		...
		int Periode_en_Tck = 91*72;
		// Dans le fichier son, on possède la periode du son en microsecondes. Par exemple, pour bruitverre, la periode est de 91 microsecondes.
		// Il faut transformer ça en nombre de periodes de CPU. Une periode de CPU = 1/72MHz. => Nb_periodes_CPU = 91*72.
